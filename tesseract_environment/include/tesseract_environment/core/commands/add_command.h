...
public:
   ...
   */
  AddCommand(const tesseract_scene_graph::Link::ConstPtr& link)
   ...
   */
  AddCommand(const tesseract_scene_graph::Link::ConstPtr& link, const tesseract_scene_graph::Joint::ConstPtr& joint)
