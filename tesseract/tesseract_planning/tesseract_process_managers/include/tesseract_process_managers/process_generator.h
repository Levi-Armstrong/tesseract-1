...
public:
   ...
   * @brief Generate Task
   *
   * IMPORTANT: references to start_instruction and end_instruction along with references inside /p input must remain
   * around for the life of the task.
   *
   * @param input The process input
   * @param start_instruction The start instruction (Must support NullInstruction)
   * @param end_instruction The end instruction (Must support NullInstruction)
   * @return Task generation function
   */
   ...
   * @param start_instruction The start instruction (Must support NullInstruction)
   * @param end_instruction The end instruction (Must support NullInstruction)
   * @return Conditional Task generation function
   */
  ...
  /** @brief The name of the process generator */
  std::string name;
};
