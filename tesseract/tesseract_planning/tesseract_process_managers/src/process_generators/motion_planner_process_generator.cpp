...
{
  return [=](){process(input, start_instruction, end_instruction);};
}
...
std::function<int()> MotionPlannerProcessGenerator::generateConditionalTask(ProcessInput input,
                                                                            ...
                                                                            const Instruction &end_instruction)
{
  return [=](){ return conditionalProcess(input, start_instruction, end_instruction);};
}

int MotionPlannerProcessGenerator::conditionalProcess(ProcessInput input,
                                                      const Instruction &start_instruction,
...
void MotionPlannerProcessGenerator::process(ProcessInput input,
                                            const Instruction &start_instruction,
                                            const Instruction &end_instruction) const
{
