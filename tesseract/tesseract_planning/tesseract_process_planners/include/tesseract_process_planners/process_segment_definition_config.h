/**
 * @file process_segment_definition_config.h
 * @brief Tesseract process segment definition configuration
 *
 ...
 */
#ifndef TESSERACT_PROCESS_PLANNERS_PROCESS_SEGMENT_DEFINITION_CONFIG_H
#define TESSERACT_PROCESS_PLANNERS_PROCESS_SEGMENT_DEFINITION_CONFIG_H

#include <tesseract_process_planners/process_step_generator.h>
...
#endif // TESSERACT_PROCESS_PLANNERS_PROCESS_SEGMENT_DEFINITION_CONFIG_H
