...
// clang-format off
  ...
  #ifdef __GNUC__
    #define TESSERACT_TIME_PARAMETERIZATION_EXPORT __attribute__ ((dllexport))
    #define TESSERACT_TIME_PARAMETERIZATION_IMPORT __attribute__ ((dllimport))
  #else
    #define TESSERACT_TIME_PARAMETERIZATION_EXPORT __declspec(dllexport)
    #define TESSERACT_TIME_PARAMETERIZATION_IMPORT __declspec(dllimport)
      ...
      #define TESSERACT_TIME_PARAMETERIZATION_PUBLIC TESSERACT_TIME_PARAMETERIZATION_EXPORT
    #else
...
#else
  #define TESSERACT_TIME_PARAMETERIZATION_EXPORT __attribute__ ((visibility("default")))
