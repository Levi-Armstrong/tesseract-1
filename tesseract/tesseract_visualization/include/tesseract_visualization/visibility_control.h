 ...
 */
#ifndef TESSERACT_VISUALIZATION_VISIBILITY_CONTROL_H
#define TESSERACT_VISUALIZATION_VISIBILITY_CONTROL_H
...
// clang-format off
  ...
  #define TESSERACT_VISUALIZATION_IMPORT
    ...
    #define TESSERACT_VISUALIZATION_LOCAL  __attribute__ ((visibility("hidden")))
  #else
    #define TESSERACT_VISUALIZATION_PUBLIC
    #define TESSERACT_VISUALIZATION_LOCAL
  #endif
  #define TESSERACT_VISUALIZATION_PUBLIC_TYPE
#endif
// clang-format on

#endif  // TESSERACT_VISUALIZATION_VISIBILITY_CONTROL_H
