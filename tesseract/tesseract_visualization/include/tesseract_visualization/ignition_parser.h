#ifndef TESSERACT_COLLISION_IGNITION_PARSER_H
#define TESSERACT_COLLISION_IGNITION_PARSER_H
...
//      KDL::RotationalInertia(inertial->ixx, inertial->iyy, inertial->izz, inertial->ixy, inertial->ixz,
//      inertial->iyz);
 ...
 *        segment to the ignition scene;
 */
struct ignition_scene_builder : public boost::dfs_visitor<>
{
  ign_tree_builder(KDL::Tree& tree) : tree_(tree) {}
...
#endif  // TESSERACT_COLLISION_IGNITION_PARSER_H
