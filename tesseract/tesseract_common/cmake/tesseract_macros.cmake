...
macro(target_process_export target)
  ...
  if (NOT DEFINED ${EXPORT_PREFIX}_LIBRARY_SHARED)
    add_definitions("-D${EXPORT_PREFIX}_LIBRARY_SHARED")
  endif()

  if(NOT BUILD_SHARED_LIBS)
    if (ARG_INTERFACE)
      target_compile_definitions(${target} INTERFACE "${EXPORT_PREFIX}_STATIC_LIBRARY")
    else()
...
macro(tesseract_variables)
  ...
  if (NOT TESSERACT_ENABLE_TESTING AND NOT TESSERACT_ENABLE_TESTING_ALL)
    ...
    if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      set(TESSERACT_COMPILE_OPTIONS -Wall -Wextra -Wconversion -Wsign-conversion -Wno-sign-compare)
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      set(TESSERACT_COMPILE_OPTIONS -Wall -Wextra -Wconversion -Wsign-conversion)
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
      set(TESSERACT_COMPILE_OPTIONS "")
    ...
    if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      set(TESSERACT_COMPILE_OPTIONS -Werror=all -Werror=extra -Werror=conversion -Werror=sign-conversion -Wno-sign-compare)
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      set(TESSERACT_COMPILE_OPTIONS -Werror=all -Werror=extra -Werror=conversion -Werror=sign-conversion)
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
      set(TESSERACT_COMPILE_OPTIONS "")
      set(TESSERACT_COMPILE_DEFINITIONS "_USE_MATH_DEFINES=ON")
    else()
