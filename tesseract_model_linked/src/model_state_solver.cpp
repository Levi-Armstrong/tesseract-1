...
{
ModelStateSolver::UPtr ModelStateSolver::clone() const
{
  auto cloned_solver = std::make_unique<ModelStateSolver>();
...
ModelState::UPtr ModelStateSolver::getState() const { return current_state_->clone(); }

ModelState::UPtr ModelStateSolver::getState(const VariableSet& variable_set) const
{
...
bool ModelStateSolver::setJointValuesHelper(KDL::JntArray& q,
...
void ModelStateSolver::calculateTransformsHelper(ModelState& state,
...
void ModelStateSolver::calculateTransforms(ModelState& state,
                                           const KDL::JntArray& q_in,
                                           const KDL::SegmentMap::const_iterator& it,
                                           const Eigen::Isometry3d& parent_frame) const
{
